      ...
      <main className="wrapper">
        ...
        <motion.div
          ...
          <motion className="w-[95%] md:w-[70%] flex-col gap-3 flex  my-[30px] sm:my-[35px] lg:my-[30px]">
            ...
            <div onClick={(() => router.replace('/forwarding'))} data-aos="zoom-in" className="w-full rounded-[40px] cursor-pointer transition-all duration-300 hover:shadow-md hover:scale-105 outline-none border-none bg-white py-2 sm:py-3 4xl:py-3 flex items-center  justify-between px-5">
              <div>
